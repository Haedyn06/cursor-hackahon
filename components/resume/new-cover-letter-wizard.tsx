...
export function NewCoverLetterWizard({
  ...
  const renderNewJob = () => (
    <div className="flex flex-col gap-5">
      ...
      {newJobMode === "link" && analyzed && (
        <div className="rounded-xl bg-[var(--yellow-l)] px-5 py-2.5 neo-border-sm">
    ...
    <SlideOver open={open} onClose={onClose} title="New Cover Letter" width={520}>
      ...
      {step === 2 && generating && (
        <div className="animate-tab-panel flex flex-col items-center gap-5 py-10 text-center">
          <div className="flex h-[70px] w-[70px] animate-pulse-soft items-center justify-center rounded-[20px] bg-[var(--yellow)] text-[30px] neo-border">
            ✦
          </div>
