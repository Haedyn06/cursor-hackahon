...
This project is indexed by GitNexus as **cursor-hackahon** (21 symbols, 12 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
